...
class BadgeForm extends React.Component{
    ...
    renderProgressBar = () => {
        ...
        variant = (withoutData <= 0) ? this.progressBar.variant : (this.progressBar.error ? this.progressBar.variant : (this.progressBar.error_api ? this.progressBar.variant : "warning"))
