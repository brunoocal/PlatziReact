    ...
    <React.Fragment>
        <div className="NoAPIBadge__container">
            ...
            <div className="NoAPIBadge__badge">
                ...
                <Badge firstName="Bruno" lastName="Cal" jobTitle="Frontend Developer" twitter="brunoo_cal" avatar="https://es.gravatar.com/userimage/198034997/96a94801273872da36f3309d6e8d6153.jpeg"></Badge>
            </div>
